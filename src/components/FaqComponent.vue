      ...
      features: [
        {
          ...
          desc:
            "Design stunning background gradients with our intuitive gradient generator. Choose colors, angles, and transitions to create eye-catching visual effects for your website.",
        ...
        },
        {
          ...
          title: "Button Styler",
          desc:
            "Easily customize and enhance your buttons with our Button Styler. Adjust colors, sizes, hover effects, and more to create attractive and responsive buttons for your web projects.",
          href: "javascript:void(0)",
        },
        {
          icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-6 h-6">
