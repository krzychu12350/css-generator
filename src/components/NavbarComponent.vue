  ...
  <div class="relative">
    ...
    <div class="relative">
      <header>
        ...
        <nav
          :class="{
            'absolute top-0 inset-x-0 bg-white shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-0 md:mt-0 md:relative md:bg-transparent': state,
          }"
        ...
        >
          <div class="flex-none space-y-5 max-w-xl">
            ...
            <h1 class="text-4xl text-gray-800 font-extrabold sm:text-5xl">
              Create animation stuff super easily and fast
            </h1>
            <p>
              Your go-to platform for creating stylish and efficient CSS code
              effortlessly.
            </p>
          ...
          <div class="flex-1 hidden md:block">
            <img
              ...
              class="max-w-xl"
            />
            <!-- <img src="../assets/image.png" class="max-w-xl" /> -->
          </div>
        </div>
      </section>
    </div>
